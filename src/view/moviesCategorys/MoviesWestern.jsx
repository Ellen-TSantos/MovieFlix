...
import { listMoviesWestern } from "../../assets/api/req";
...
export default function MoviesWestern({ navigation }) {
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <TouchableOpacity
            ...
            style={stylesMoviesCategory.cardDetails}
          >
